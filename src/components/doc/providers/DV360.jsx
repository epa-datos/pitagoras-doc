...
const Dv360 = () => {
  return (
    <Space id="dv360" direction="vertical" style={{ width: "100%" }}>
      <h2>Display Video 360</h2>
      <p>
        Para descargar un reporte es necesario seleccionar una <i>agrupación</i> y una{" "}
        <i>métrica.</i>
      </p>
      ...
      <p>
        ...
        <ul>
          <li>
            <a href="https://developers.google.com/bid-manager/reference/rest/v2/filters-metrics#filters">
        ...
        <ul>
          <li>
            <a href="https://developers.google.com/bid-manager/reference/rest/v2/filters-metrics#metrics">
              Métricas
            </a>
          </li>
        </ul>
